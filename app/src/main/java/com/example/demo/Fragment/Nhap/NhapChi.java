...
public class NhapChi extends AppCompatDialogFragment {
    private EditText tien ,ghichu;
    private TextView lichChi;
    private Spinner spLoai;
    private View v;
    private SpinnerChiAdapter spinnerAdapter;
    List<String>names;
    int srcimg=0;
    ...
    private ShowInChiInterface showInChiInterface;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        v= inflater.inflate(R.layout.nhap_chi,null);
        tien = v.findViewById(R.id.tienChi);
                ...
                dialog.setPositiveButton("Thêm", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(edThem.getText().equals("")) Toast.makeText(getContext(),"Bạn chưa nhập danh mục muốn thêm",Toast.LENGTH_SHORT).show();
                            ...
                            sqLiteDanhMucOpenHelper.addDanhMucChi(danhMucChi);
        ...
        //set DatePicker
        btLich = v.findViewById(R.id.btLichChi);
        ...
        builder.setView(v).setTitle("Nhập khoản chi").setPositiveButton("LƯU", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ...
                String lich = lichChi.getText().toString();
                ...
                if(tien.getText().toString().isEmpty()){
                    ...
                    showInChiInterface.sendChi(src,loai,tient,lich,gc);
                    dialog.dismiss();
                }
    ...
    public List<String> getDataLoai(){
        ...
        danhMuc = sqLiteDanhMucOpenHelper.getDanhMucChiAll();
        if(danhMuc.isEmpty()){
            sqLiteDanhMucOpenHelper.createDanhMucChi();
            danhMuc = sqLiteDanhMucOpenHelper.getDanhMucChiAll();
        }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try{
            showInChiInterface = (ShowInChiInterface) getTargetFragment();
        }catch (Exception e){
            e.printStackTrace();
        }
    }

    public interface ShowInChiInterface {
        void sendChi(int src,String loai, String tien, String tgian, String ghiChu);
    }
}